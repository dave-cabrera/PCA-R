...
# We should use 3 groups/means according to the silhouette plot

set.seed(123)
k1 = kmeans(cities_norm, 3, 25)
fviz_cluster(k1, cities_norm)

fviz_nbclust(cities_norm, kmeans, method = "wss")
# According to the within sum of squares method, we should have 4 clusters

set.seed(123)
k2 = kmeans(cities_norm, 4, 25)
fviz_cluster(k2, cities_norm)
